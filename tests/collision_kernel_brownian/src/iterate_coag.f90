...
subroutine iterate_coag(path_data,path_log,chnbins,nbins,kpol,massgrid,massbins,massmeanlog,Q,vecnodes,vecweights,ndthydro,dthydro,dv)
   implicit none
   ...
   !log simu add Arrays generated time
   if (isave) then
